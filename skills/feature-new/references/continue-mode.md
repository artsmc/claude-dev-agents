# Continue Mode — Detailed Resume Procedure

Full procedure for `/feature-new --continue` (formerly the standalone `/feature-continue` skill). Resume interrupted feature development from a task-list.md with PM-DB tracking intact, skipping completed tasks.

## Usage

```bash
/feature-new --continue ./job-queue/feature-auth/tasks.md
/feature-new --continue ./my-feature/tasks.md
```
...
# Day 2: Resume
/feature-new --continue ./job-queue/feature-payment/tasks.md
...
# (manually fix issues)
/feature-new --continue ./job-queue/feature-admin/tasks.md
